...
2. 實作一個計算體積的函式，最後以字串的方式回傳體積大小。
3. 承上，計算體積的函式請加入控制參數，此參數可以控制回傳值顯示如下：
   1. 請四捨五入至小數第3位，如：3.1415926 -> 3.142
   2. 請無條件捨去至小數第3位，如：3.1415926 -> 3.141
   3. 請無條件進位至小數第1位，如：3.1415926 -> 3.2
